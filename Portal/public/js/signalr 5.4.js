...
var DefaultHttpClient = /** @class */ (function (_super) {
    ...
    function DefaultHttpClient(logger) {
        console.log("DefaultHttpClient:", this)
    ...
    DefaultHttpClient.prototype.send = function (request) {
        ...
        console.log("DefaultHttpClient: send ", request)
...
var FetchHttpClient = /** @class */ (function (_super) {
    ...
    function FetchHttpClient(logger) {
        var _this = _super.call(this) || this;
        _this.logger = logger;
        console.log("FetchHttpClient:", this,_this, fetch, _this.fetchType, _this.abortControllerType,)
    ...
    FetchHttpClient.prototype.send = function (request) {
        console.log("FetchHttpClient send:", this, request)
        return __awaiter(this, void 0, void 0, function () {
            var abortController, error, timeoutId, msTimeout, response, e_1, content, payload;
            var _this = this;
            console.log("FetchHttpClient send:", this, abortController, error, timeoutId, msTimeout, response, e_1, content, payload)
            return __generator(this, function (_a) {
                console.log("FetchHttpClient a:", this, _a)
             //   _a.label = 6
                switch (_a.label) {
                    case 0:
                        // Check that abort was not signaled before calling send
    ...
    FetchHttpClient.prototype.getCookieString = function (url) {
        console.log("FetchHttpClient getCookieString:", this, url)
        var cookies = "";
