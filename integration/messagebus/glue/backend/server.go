...
import (
	...
	"github.com/mdaxf/iac/integration/messagebus/glue/backend/sockets/ajaxsocket"
	"github.com/mdaxf/iac/integration/messagebus/glue/backend/sockets/websocket"
	"github.com/mdaxf/iac/integration/messagebus/glue/log"
	"github.com/mdaxf/iac/integration/messagebus/glue/utils"
...
func NewServer(httpURLStripLength int, enableCORS bool, checkOrigin func(r *http.Request) bool) *Server {
	// Create a new backend server. func(r *http.Request) bool
	s := &Server{
