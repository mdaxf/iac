-- =====================================================
-- Demo Plan Scheduler Profile with Sample Data - MySQL
...
INSERT INTO plan_scheduler_profile_constraints (
    ...
    'json',
    '{"workStartHour":9,"workEndHour":17,"breakStartHour":12,"breakEndHour":13,"workDays":[1,2,3,4,5],"nonWorkColor":"rgba(241,245,249,0.6)"}',
    'hard',
    1,
    1,
    'TIME-STD',
...
INSERT INTO plan_scheduler_profile_constraints (
    ...
    'json',
    '{"maxConcurrentTasks":3,"allowOverallocation":false}',
    'hard',
    2,
    1,
    'RES-CAP',
...
INSERT INTO plan_scheduler_profile_constraints (
    ...
    'json',
    '{"strictDependencies":true,"allowNegativeLag":false}',
    'hard',
    3,
    1,
    'DEP-FS',
...
-- Count profile data
SELECT 'Profile' as entity, COUNT(*) as count
FROM plan_scheduler_profiles
WHERE id = 'demo-profile-001'

UNION ALL

SELECT 'Data Sources' as entity, COUNT(*) as count
FROM plan_scheduler_profile_datasources
WHERE profile_id = 'demo-profile-001'

UNION ALL

SELECT 'Constraints' as entity, COUNT(*) as count
FROM plan_scheduler_profile_constraints
WHERE profile_id = 'demo-profile-001'

UNION ALL

SELECT 'Settings' as entity, COUNT(*) as count
