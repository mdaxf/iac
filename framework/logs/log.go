// the package is exported from github.com/beego/beego/v2/core/logs
...
// IACLogger is default logger in iac application.
...
// NewLogger returns a new IACLogger.
...
// SetLogger provides a given logger adapter into IACLogger with config string.
...
func (bl *IACLogger) writeToLoggers(lm *LogMsg) {
	for _, l := range bl.outputs {
		err := l.WriteMsg(lm)
		if err != nil {
...
func (bl *IACLogger) writeMsg(lm *LogMsg) error {
	if !bl.init {
		bl.lock.Lock()
		bl.setLogger(AdapterConsole)
		bl.lock.Unlock()
...
func (bl *IACLogger) setGlobalFormatter(fmtter string) error {
...
func SetGlobalFormatter(fmtter string) error {
	return iacLogger.setGlobalFormatter(fmtter)
}
...
// iacLogger references the used application logger.
var iacLogger = NewLogger()
...
func GetLogger(prefixes ...string) *log.Logger {
	...
	iacLoggerMap.RLock()
	l, ok := iacLoggerMap.logs[prefix]
	if ok {
		iacLoggerMap.RUnlock()
		return l
	}
	iacLoggerMap.RUnlock()
	iacLoggerMap.Lock()
	defer iacLoggerMap.Unlock()
	l, ok = iacLoggerMap.logs[prefix]
	if !ok {
		l = log.New(iacLogger, prefix, 0)
		iacLoggerMap.logs[prefix] = l
	}
	return l
}

// EnableFullFilePath enables full file path logging. Disabled by default
// e.g "/home/Documents/GitHub/iac/mainapp/" instead of "mainapp"
func EnableFullFilePath(b bool) {
	iacLogger.enableFullFilePath = b
}
...
func Async(msgLen ...int64) *IACLogger {
	return iacLogger.Async(msgLen...)
}

// SetLevel sets the global log level used by the simple logger.
func SetLevel(l int) {
	iacLogger.SetLevel(l)
}

// SetPrefix sets the prefix
func SetPrefix(s string) {
	iacLogger.SetPrefix(s)
}

// EnableFuncCallDepth enable log funcCallDepth
func EnableFuncCallDepth(b bool) {
	iacLogger.enableFuncCallDepth = b
}

// SetLogFuncCall set the CallDepth, default is 4
func SetLogFuncCall(b bool) {
	iacLogger.EnableFuncCallDepth(b)
	iacLogger.SetLogFuncCallDepth(3)
}

// SetLogFuncCallDepth set log funcCallDepth
func SetLogFuncCallDepth(d int) {
	iacLogger.loggerFuncCallDepth = d
}

// SetLogger sets a new logger.
func SetLogger(adapter string, config ...string) error {
	return iacLogger.SetLogger(adapter, config...)
}

// Emergency logs a message at emergency level.
func Emergency(f interface{}, v ...interface{}) {
	iacLogger.Emergency(formatPattern(f, v...), v...)
}

// Alert logs a message at alert level.
func Alert(f interface{}, v ...interface{}) {
	iacLogger.Alert(formatPattern(f, v...), v...)
}

// Critical logs a message at critical level.
func Critical(f interface{}, v ...interface{}) {
	iacLogger.Critical(formatPattern(f, v...), v...)
}

// Error logs a message at error level.
func Error(f interface{}, v ...interface{}) {
	iacLogger.Error(formatPattern(f, v...), v...)
}

// Warning logs a message at warning level.
func Warning(f interface{}, v ...interface{}) {
	iacLogger.Warn(formatPattern(f, v...), v...)
}
...
func Notice(f interface{}, v ...interface{}) {
	iacLogger.Notice(formatPattern(f, v...), v...)
}

// Informational logs a message at info level.
func Informational(f interface{}, v ...interface{}) {
	iacLogger.Info(formatPattern(f, v...), v...)
}
...
func Debug(f interface{}, v ...interface{}) {
	iacLogger.Debug(formatPattern(f, v...), v...)
}

// Trace logs a message at trace level.
// compatibility alias for Warning()
func Trace(f interface{}, v ...interface{}) {
	iacLogger.Trace(formatPattern(f, v...), v...)
}
